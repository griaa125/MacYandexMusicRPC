...
class ConfigManager:
    def __init__(self, config_file='settings.ini', temp_dir_name="MacYandexMusicRPC"):
        # macOS: ~/Library/Application Support/<app>
        app_support = os.path.join(os.path.expanduser("~"), "Library", "Application Support", temp_dir_name)
        self.temp_dir = app_support
